...
(function() {
  var ClientRequest, Q, _, api, cloudinary, expect, fs, helper, http, sinon, utils;
  ...
  describe('Cloudinary::Api', function() {
    ...
    after(function() {
      ...
      if (!cloudinary.config().keep_test_products) {
        return cloudinary.v2.api.delete_streaming_profile(test_id_3);
      }
    });
    ...
    describe('list_streaming_profile', function() {
      return it('should list streaming profile', function(done) {
        return api.list_streaming_profiles(function(error, result) {
          var i, len, profile;
          expect(error).to.be(void 0);
    ...
    describe('delete_streaming_profile', function() {
      return it('should delete a streaming profile', function(done) {
        ...
        return api.create_streaming_profile(test_id_2, {
          ...
          expect(error).to.be(void 0);
          expect(result).not.to.be(void 0);
          return api.delete_streaming_profile(test_id_2, function(error, result) {
            expect(error).to.be(void 0);
    ...
    describe('get_streaming_profile', function() {
      return it('should get a specific streaming profile', function(done) {
        return api.get_streaming_profile(PREDEFINED_PROFILES[1], function(error, result) {
          expect(error).to.be(void 0);
      ...
      return it('should create a streaming profile with representations', function(done) {
        return api.create_streaming_profile(test_id_3, {
          ...
          return api.update_streaming_profile(test_id_3, {
            ...
            expect(error).to.be(void 0);
            expect(result).not.to.be(void 0);
            return api.get_streaming_profile(test_id_3, function(error, result) {
              expect(error).to.be(void 0);
              result = result['data'];
